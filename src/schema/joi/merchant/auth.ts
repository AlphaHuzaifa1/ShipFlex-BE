...
const registerSchema = Joi.object({
  ...
  company_name: Joi.string().trim().required().min(2).max(100).messages({
  ...
  company_contact_number: Joi.string()
    ...
    .messages({
      "string.min":
        "Company contact number must be at least 10 characters long",
      "string.max": "Company contact number must be at most 15 characters long",
